...
\textbf{Subactividad 4b — Web scraping, NLP y RAG (Saturía):}

\begin{itemize}
\item Extracción mediante web scraping de anuncios BOE/PLACE con BeautifulSoup
...
\item Fase 4: web scraping, NLP y motor RAG (lead)
...
\hline
4b & Scraping/NLP & Corpus, motor RAG & Saturía & 3 \\
\hline
